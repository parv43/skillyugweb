  ...
  return (
    <section className="py-24 relative overflow-hidden flex flex-col items-center justify-center border-t border-slate-100 dark:border-slate-900 bg-white dark:bg-[#020617]">
      ...
      <div className="relative w-full z-10 pt-4 pb-8 overflow-hidden">
        ...
        {/* Edge fade gradients */}
        <div className="absolute top-0 bottom-0 left-0 w-20 md:w-48 bg-gradient-to-r from-background via-background/80 to-transparent z-20 pointer-events-none" />
        <div className="absolute top-0 bottom-0 right-0 w-20 md:w-48 bg-gradient-to-l from-background via-background/80 to-transparent z-20 pointer-events-none" />
      </div>
