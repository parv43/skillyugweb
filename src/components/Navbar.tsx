    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-12 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center group transition-all" aria-label="Skillyug Home">
          <img src="/skillyug.png" alt="Skillyug Logo" className="h-11 md:h-15 object-contain scale-[1.8] transform-gpu hover:scale-[1.9] transition-transform duration-300" />
        </Link>
