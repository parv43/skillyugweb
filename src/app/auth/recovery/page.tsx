...
function RecoveryHandler() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center gap-4 select-none">
      {status === "processing" ? (
        <>
        ...
        <p className="text-red-500 text-sm font-medium">Something went wrong. Redirecting…</p>
      )}
    </div>
  )
}
