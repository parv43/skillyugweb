  ...
  return (
    <main className="bg-transparent min-h-screen text-slate-800 dark:text-slate-200 font-sans">
      ...
      <div className="max-w-[800px] mx-auto pt-32 pb-24 px-6 md:px-8">
        ...
        <h1 className="text-3xl md:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#0060aa] via-[#8b5cf6] to-[#ff8b12] mb-2">Terms & Conditions</h1>
        <p className="text-slate-500 dark:text-slate-400 text-sm mb-12">Last updated on 02-04-2026 22:24:07</p>
