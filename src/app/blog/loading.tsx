    ...
    <main className="bg-[#020617] min-h-screen text-slate-50 font-sans relative pb-20">
      ...
      <div className="container mx-auto px-6 relative z-10 pt-36 lg:pt-44">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <div className="h-12 w-3/4 mx-auto rounded-xl bg-slate-800 animate-pulse border border-slate-700" />
          <div className="h-6 w-1/2 mx-auto rounded-lg bg-slate-800 animate-pulse border border-slate-700" />
        </div>

        {/* Featured card skeleton */}
        <div className="mb-20 rounded-[24px] overflow-hidden bg-slate-800/50 border border-slate-700">
          <div className="flex flex-col lg:flex-row">
            <div className="w-full lg:w-1/2 h-64 bg-slate-800 animate-pulse" />
            <div className="w-full lg:w-1/2 p-8 lg:p-12 space-y-4">
              <div className="h-4 w-1/4 rounded bg-slate-700 animate-pulse" />
              <div className="h-8 w-3/4 rounded-xl bg-slate-700 animate-pulse" />
              <div className="h-4 w-full rounded bg-slate-700 animate-pulse" />
              <div className="h-4 w-2/3 rounded bg-slate-700 animate-pulse" />
              <div className="h-10 w-36 rounded-full bg-slate-700 animate-pulse mt-4" />
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {Array.from({ length: 9 }).map((_, i) => (
            <div key={i} className="rounded-[20px] bg-slate-800/50 border border-slate-700 overflow-hidden">
              <div className="w-full h-48 bg-slate-800 animate-pulse" />
              <div className="p-6 space-y-3">
                <div className="h-3 w-1/3 rounded bg-slate-700 animate-pulse" />
                <div className="h-5 w-full rounded-lg bg-slate-700 animate-pulse" />
                <div className="h-5 w-4/5 rounded-lg bg-slate-700 animate-pulse" />
                <div className="h-4 w-full rounded bg-slate-700 animate-pulse" />
                <div className="h-4 w-2/3 rounded bg-slate-700 animate-pulse" />
              </div>
            </div>
